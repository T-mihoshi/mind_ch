...
urlpatterns = [
    ...
    path('memo_create/new/', views.memo_create, name='memo_create'),
    path('memo_edit/<int:memo_id>/edit/', views.memo_edit, name='memo_edit'),
    path('memo_delete/<int:memo_id>/delete/', views.memo_delete, name='memo_delete'),
